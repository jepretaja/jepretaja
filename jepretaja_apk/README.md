...
- Copywriting UI utama sekarang mengikuti konteks pengguna melalui
  `ui/copy/RoleCopy.kt`: tamu mendapat bahasa eksplorasi, konsumen mendapat
  bahasa pemesanan, dan creator mendapat bahasa studio/operasional. Sumber
  copy disediakan lewat `LocalJepretAjaCopy` agar layar baru tetap bisa
  mengikuti peran tanpa menyalin kondisi role di setiap komponen.
