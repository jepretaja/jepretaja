...
class UploadWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        return try {
            ...
            if (isVideo) {
                ...
                docRef.set(
                    dokumenPost(
                        ...
                        title, caption, category, location, mentions, commentPolicy, allowSave, allowLike, allowDownload, showLikeCount, visibility, durasi, "Explore",
                ...
                if (target == "Portfolio") {
                    ...
                    db.collection(FirestorePaths.EXPLORE_POSTS).add(
                        dokumenPost(
                            ...
                            title, caption, category, location, mentions, commentPolicy, allowSave, allowLike, allowDownload, showLikeCount, visibility, null, target,
                            packageId, packageName, packagePrice,
                        )
                    ).await()
                }
            ...
            gagalkan(
                caption, title, category, target, uris, isVideo,
    ...
    private fun dokumenPost(
        ...
        "title" to title, "caption" to caption, "category" to category, "location" to location,
