...
val admobNativeAdUnitId: String =
    (project.findProperty("ADMOB_NATIVE_AD_UNIT_ID") as String?)
...
android {
    ...
    defaultConfig.manifestPlaceholders["ADMOB_APP_ID"] = admobAppId
...
dependencies {
    ...
    // Dipakai collectAsStateWithLifecycle() di semua layar: mengumpulkan
    // StateFlow/Flow hanya saat layar benar-benar terlihat (STARTED), bukan
    // terus-menerus walau layar sedang ditumpuk layar lain atau di background.
    // Sebelumnya semua layar memakai collectAsState() biasa, yang tetap
    // mengumpulkan dan memicu rekomposisi walau layarnya tidak aktif —
    // salah satu penyebab aplikasi terasa berat saat berpindah halaman.
    ...
    implementation("com.google.android.gms:play-services-ads:23.5.0") // Google AdMob
