...
export default function CreatorChats() {
  ...
  // Membuka percakapan adalah tindakan membaca; tombol manual tetap tersedia
  // untuk kasus ketika pesan baru masuk saat ruang sedang terbuka.
  useEffect(() => {
    if (dipilih) tandaiDibaca();
  }, [dipilih, semuaPesan]);
              ...
              return (
                ...
                >
                  <div className="flex-between">
                    <strong>{c.customerName || c.otherPartyName || c.customerId || 'Pelanggan'}</strong>
            ...
            {!chatAktif ? (
              ...
              <>
                <div className="chat-kepala flex-between">
                  <strong>{chatAktif.customerName || chatAktif.otherPartyName || chatAktif.customerId || 'Pelanggan'}</strong>
