...
export default function Landing() {
  ...
  return (
    <div className="landing">
        ...
        <div className="landing-container landing-header-inner">
          <Link to="/" className="landing-brand">
            ...
            <span>
              ...
              <span className="landing-brand-sub">Aplikasi creator & booking</span>
            </span>
          </Link>
          <nav className="landing-nav">
            <Link to="/tentang">Tentang</Link>
            <Link to="/artikel">Artikel</Link>
            <Link to="/panduan">Cara Kerja</Link>
            <Link to="/kontak">Kontak</Link>
            <Link to="/status">Status Sistem</Link>
            <a className="btn btn-download" href={APK_DOWNLOAD_URL} download>Unduh APK</a>
            <Link className="btn btn-primary" to="/login">Masuk Admin</Link>
          </nav>
        </div>
      </header>
      ...
      <section className="landing-hero">
        <div className="landing-container landing-hero-layout">
          <div className="landing-hero-copy">
            ...
            <h1 className="landing-title">Temukan momen. <em>Bangun karya.</em></h1>
            <p className="landing-subtitle">
              JepretAja adalah aplikasi untuk booking fotografer, menemukan karya terbaik, dan
              membantu creator mengelola portofolio, paket, dan pesanan dari satu tempat.
            </p>
            <div className="landing-cta">
              <a className="btn btn-download btn-lg landing-app-cta" href={APK_DOWNLOAD_URL} download>Unduh APK Android <span aria-hidden="true">-&gt;</span></a>
              <Link className="btn btn-ghost btn-lg" to="/login">Portal Admin</Link>
            </div>
            <div className="landing-hero-note"><span className="landing-note-check">&#10003;</span> Satu aplikasi untuk customer dan creator</div>
          </div>
          <div className="landing-product-preview apk-preview" aria-label="Pratinjau aplikasi JepretAja">
            <div className="preview-glow" />
            <div className="preview-window">
              <div className="preview-toolbar"><span className="preview-brand"><span className="preview-brand-mark">JA</span> JepretAja <small>APK</small></span><span className="preview-avatar">JA</span></div>
              <div className="preview-body">
                <div className="preview-greeting"><span>Selamat datang di JepretAja</span><strong>Cari creator terbaikmu</strong></div>
                <div className="preview-stats">
                  <div><span>Creator terdekat</span><strong>24</strong><small className="preview-up">siap booking</small></div>
                  <div><span>Karya pilihan</span><strong>1.284</strong><small className="preview-up">dari komunitas</small></div>
                </div>
                <div className="preview-app-card"><span className="preview-app-thumb" /><span><b>Wedding & Prewedding</b><small>Creator terverifikasi · ⭐ 4.9</small></span><strong>›</strong></div>
                <div className="preview-app-nav"><span className="active">⌂<small>Home</small></span><span>⌕<small>Explore</small></span><span>＋<small>Upload</small></span><span>♡<small>Profil</small></span></div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="landing-app-features landing-container">
        <div className="landing-feature-intro"><span className="status-eyebrow">JepretAja mobile</span><h2>Lebih dekat dengan karya yang ingin Anda wujudkan.</h2><p>Pengalaman utama JepretAja hadir di APK: cepat, personal, dan dibuat untuk alur booking nyata.</p></div>
        <div className="landing-feature-grid">
          <article className="landing-feature-card"><span className="feature-number">01</span><h3>Booking tanpa ribet</h3><p>Pilih paket, cek tanggal, dan lanjutkan pembayaran dengan alur yang jelas.</p></article>
          <article className="landing-feature-card"><span className="feature-number">02</span><h3>Creator Studio</h3><p>Creator mengunggah karya, mengatur paket, menerima booking, dan memantau pendapatan.</p></article>
          <article className="landing-feature-card"><span className="feature-number">03</span><h3>Explore yang hidup</h3><p>Temukan gaya visual, creator lokal, dan inspirasi yang relevan untuk momen Anda.</p></article>
        </div>
      </section>

      <main className="landing-container landing-main" style={{ display: 'none' }}>
      ...
      <footer className="landing-footer">
        <div className="landing-container landing-footer-inner">
          ...
          <div className="landing-footer-meta">
            <div className="text-meta">
              <Link to="/tentang">Tentang</Link> · <Link to="/artikel">Artikel</Link> · <Link to="/kontak">Kontak</Link> · <Link to="/privasi">Kebijakan Privasi</Link> · <Link to="/syarat">Syarat Layanan</Link> · <Link to="/hapus-akun">Hapus Akun</Link>
            </div>
