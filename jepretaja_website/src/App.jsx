...
import PublicCreatorProfile from './pages/public/PublicCreatorProfile';
    ...
    >
      <AuthProvider>
        <Routes>
          ...
          <Route path="/artikel/:slug" element={<Articles />} />
          <Route path="/profil/:id" element={<PublicCreatorProfile />} />
          <Route path="/karya/:id" element={<PublicPost />} />
          ...
          <Route path="/status" element={<Lazy><SystemStatus /></Lazy>} />
