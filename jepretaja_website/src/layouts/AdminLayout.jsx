...
export default function AdminLayout() {
  ...
  return (
    <div className="admin-shell">
      <Sidebar terbuka={bukaSidebar} onClose={() => setBukaSidebar(false)} />
      {bukaSidebar && <button className="mobile-nav-overlay" aria-label="Tutup navigasi" onClick={() => setBukaSidebar(false)} />}
      <div className="main">
        <div className="topbar">
          <button className="mobile-menu-btn" type="button" aria-label="Buka navigasi" onClick={() => setBukaSidebar(true)}>☰</button>
          <div className="topbar-context">Admin Console</div>
